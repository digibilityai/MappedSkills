...
import { Breadcrumb, CommercialSection, ChapterLabel, Display, Note } from '@/components/commercial/primitives';
  ...
  return (
    <>
      ...
      <CommercialHero
        ...
        <h1 className='m-0 mt-[clamp(14px,1.8vw,22px)] font-heading text-[clamp(2rem,4.6vw,3.9rem)] font-extrabold leading-[0.98] tracking-[-0.038em] max-w-none text-black'>AI search: why your business is not in the answer, and <span style={{ color: 'var(--resolve-accent-deep)' }}>what actually moves it.</span></h1>
        <p className='text-[clamp(1.06rem,1.35vw,1.28rem)]'>
          Yes, we work on whether a business shows up when someone asks an AI assistant for a supplier like you. It is a real question with a mostly unglamorous answer: those answers are assembled largely from sources that sit outside your website, and being readable by the systems is not the same as being chosen by them.
        </p>
        <p className='text-[clamp(1.06rem,1.35vw,1.28rem)]'>We measure it per system, we publish the run counts, and we do not sell a score.</p>
      </CommercialHero>

      {/* ---- MOVE 3 — the buyer's problem, and the misinformation named ---- */}
      <CommercialSection>
        <div className="max-w-[95%] max-[1024px]:max-w-none">
          <Display className="max-w-none">The situation this is <span style={{ color: 'var(--resolve-accent-deep)' }}> usually bought to fix </span></Display>
          ...
          <div className="mt-[clamp(20px,2.4vw,32px)] border-l-4 pl-[clamp(18px,2.2vw,30px)]" style={{ borderColor: 'var(--resolve-gap)' }}>
            <p className="m-0 max-w-none text-resolve-dim leading-relaxed">
      ...
      <CommercialSection tone="paper" mode="wide">
        <Display className="max-w-none">What the work <span style={{ color: 'var(--resolve-accent-deep)' }}>involves</span></Display>
      ...
      <CommercialSection>
        <div className="max-w-[95%] max-[1024px]:max-w-none">
          <Display className="max-w-none">What we measure, and <span style={{ color: 'var(--resolve-accent-deep)' }}> what we report </span></Display>
          <p className="mt-[18px] max-w-none text-resolve-dim leading-relaxed">
      ...
      <CommercialSection tone="paper">
        <Display className="max-w-none">The questions we <span style={{ color: 'var(--resolve-accent-deep)' }}> get asked here</span></Display>
      ...
      <CommercialClose
        ...
        heading={
          <>
            One discovery surface, and today{' '}
            <span style={{ color: 'var(--resolve-accent-deep)' }}>a small one.</span>
          </>
        }
        body={
          <>
