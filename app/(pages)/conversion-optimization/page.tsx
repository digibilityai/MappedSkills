  ...
  return (
    <>
      ...
      <CommercialHero
        ...
        <h1 className='m-0 mt-[clamp(14px,1.8vw,22px)] font-heading text-[clamp(2rem,4.6vw,3.9rem)] font-extrabold leading-[0.98] tracking-[-0.038em] max-w-none text-black'>Turning visits into enquiries, after finding out <span style={{ color: 'var(--resolve-accent-deep)' }}> where they are actually being lost.</span></h1>
        <p className='text-[clamp(1.06rem,1.35vw,1.28rem)]'>
          Yes, this is the work you came looking for: finding why visits are not becoming enquiries, and fixing it. The reason the page starts with diagnosis rather than a list of tactics is that in at least two of the four places demand gets lost, changing the page is the wrong intervention — and doing it anyway is how a quarter gets spent with nothing to show.
        </p>
        <p className='text-[clamp(1.06rem,1.35vw,1.28rem)]'>
      ...
      <CommercialSection>
        <div className="max-w-[68%] max-[1024px]:max-w-none">
          <Display className="max-w-none">What this work is usually <span style={{ color: 'var(--resolve-accent-deep)' }}> brought in to do</span></Display>
      ...
      <CommercialClose
        ...
        heading={
          <>
            What arrives, what converts,{' '}
            <span style={{ color: 'var(--resolve-accent-deep)' }}>what you can measure.</span>
          </>
        }
        body={
          <>
