...
export default function FaqPage() {
  return (
    <>
      ...
      <RouteHero
        eyebrow="Questions"
        title={<>Questions we get asked, <span style={{ color: 'var(--resolve-accent-deep)' }}> answered plainly.</span></>}
        lede={<><p className='text-[clamp(1.06rem,1.35vw,1.28rem)]'>Including the ones with answers that lose us work.</p></>} mode="editorial">
      ...
      <CommercialClose
        ...
        heading={<>The awkward ones get the same <span style={{ color: 'var(--resolve-accent-deep)' }}>answer either way.</span></>}
