  ...
  return (
    <>
      ...
      <CommercialHero
        ...
        <h1 className='m-0 mt-[clamp(14px,1.8vw,22px)] font-heading text-[clamp(2rem,4.6vw,3.9rem)] font-extrabold leading-[0.98] tracking-[-0.038em] max-w-none text-black'>Google Ads, measured on the enquiries <span style={{ color: 'var(--resolve-accent-deep)' }}> rather than the clicks.</span></h1>
        <p className='text-[clamp(1.06rem,1.35vw,1.28rem)]'>
          We run paid search: account structure, keywords, negatives, ad copy, bidding and budget. We also take responsibility for what happens after the click — the page it lands on, whether the enquiry completes, and whether you can see where it came from.
        </p>
        <p className='text-[clamp(1.06rem,1.35vw,1.28rem)]'>
      ...
      <CommercialSection>
        <Display className="max-w-none">Where paid search <span style={{ color: 'var(--resolve-accent-deep)' }}> sits in the work</span></Display>
      ...
      <CommercialSection tone="paper">
        <BoundaryBlock
          ...
          closing="These depend on your market, your price, your competitors and your own follow-up, none of which we control."
        >
          <p>
      ...
      <CommercialClose
        ...
        heading={<>What you spend, and what you <span style={{ color: 'var(--resolve-accent-deep)' }}>get back.</span></>}
        body={
          <>
