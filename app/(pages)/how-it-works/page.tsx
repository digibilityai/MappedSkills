...
const JUDGEMENT = [
  <>
    <strong className="font-bold text-resolve-ink">Which demand is worth capturing.</strong>{' '}
    <span className="text-resolve-dim">Much of what looks like demand in this market is students, job-seekers and competitors.</span>
  </>,
  <>
    <strong className="font-bold text-resolve-ink">Which of four failures a symptom indicates</strong>
    <span className="text-resolve-dim">, when the evidence is partial.</span>
  </>,
  <>
    <strong className="font-bold text-resolve-ink">Whether an enquiry is a real fit.</strong>{' '}
    <span className="text-resolve-dim">The website can check that an enquiry is real, reachable and in context. It cannot judge what an opportunity is worth to you, and no form can. That is a conversation.</span>
  </>,
  <>
    <strong className="font-bold text-resolve-ink">What a partial measurement means</strong>
    <span className="text-resolve-dim">, and what it does not license us to say.</span>
  </>,
  <>
    <strong className="font-bold text-resolve-ink">When to tell a client a channel is wrong</strong>{' '}
    <span className="text-resolve-dim">for their business, including when we would be paid to run it.</span>
  </>,
];
...
const CLIENT_PROVIDES = [
  <>
    <strong className="font-bold text-resolve-ink">Access.</strong>{' '}
    <span className="text-resolve-dim">Analytics, search console, ad accounts, the site itself, and the systems where enquiries land.</span>
  </>,
  <>
    <strong className="font-bold text-resolve-ink">Decisions, at a reasonable pace.</strong>{' '}
    <span className="text-resolve-dim">Work that waits three weeks for an approval loses more than it looks like it does.</span>
  </>,
  <>
    <strong className="font-bold text-resolve-ink">Product knowledge.</strong>{' '}
    <span className="text-resolve-dim">What you sell, who buys it, what they ask before they buy, and what a good customer looks like. Nobody outside your business has that.</span>
  </>,
  <>
    <strong className="font-bold text-resolve-ink">Capacity to follow up.</strong>{' '}
    <span className="text-resolve-dim">An enquiry that is not answered is not a result, and it is the one part of the chain we do not control.</span>
  </>,
];
  ...
  return (
    <>
      ...
      <RouteHero
        ...
        title={<>How we work, what we measure, and <em className="not-italic" style={{ color: 'var(--resolve-accent-deep)' }}> what we cannot tell you.</em></>}
        lede={
          <>
            <p className='text-[clamp(1.06rem,1.35vw,1.28rem)]'>This page exists to be checked. It sets out how the work is done, what is measured at each point,
            what a measurement can and cannot support, and where the judgement calls are.</p>
          </>
        } mode="editorial">
      ...
      <CommercialSection tone="paper">
        <div className="max-w-[95%] max-[1024px]:max-w-none">
          ...
          <Display>Two observations sit underneath <span style={{ color: 'var(--resolve-accent-deep)' }}> everything below.</span></Display>
      ...
      */}
      ...
      <CommercialSection mode="wide">
        ...
        <Display>Six points on <span style={{ color: 'var(--resolve-accent-deep)' }}> one chain.</span></Display>
      ...
      <CommercialSection tone="paper">
        <BoundaryBlock
          ...
          heading={<>Six things this method <span style={{ color: 'var(--resolve-accent-deep)' }}> does not produce.</span></>}
          notPromised={[
      ...
      <CommercialSection>
        ...
        <Display>Attribution is useful, incomplete, and <span style={{ color: 'var(--resolve-accent-deep)' }}> unevenly incomplete.</span></Display>
        <p className="mt-4 max-w-none text-resolve-dim leading-relaxed">
        ...
        <div className="mt-[clamp(26px,3.2vw,44px)] max-w-none text-resolve-dim leading-relaxed [&>p+p]:mt-4">
          <p className="m-0">
        ...
        <p
          className="mt-[clamp(28px,3.4vw,48px)] max-w-none border-l-4 pl-[clamp(18px,2.2vw,30px)] text-[clamp(1.1rem,1.8vw,1.42rem)] font-semibold leading-[1.35]"
      ...
      <CommercialSection tone="paper">
        ...
        <Display>Five places, named rather than <span style={{ color: 'var(--resolve-accent-deep)' }}> hidden behind process language.</span></Display>
      ...
      <CommercialSection>
        ...
        <Display>Three subordinate roles, <span style={{ color: 'var(--resolve-accent-deep)' }}> stated at their real size.</span></Display>
      ...
      <CommercialSection tone="paper">
        ...
        <Display>Four requirements, <span style={{ color: 'var(--resolve-accent-deep)' }}> not four requests.</span></Display>
        <p className="mt-4 max-w-none text-resolve-dim leading-relaxed">The work does not function without them, which is why they are stated this way.</p>
      ...
      */}
      ...
      <CommercialSection>
        ...
        <Display>Visible, rather than <span style={{ color: 'var(--resolve-accent-deep)' }}> a footnote.</span></Display>
        <div className="mt-[clamp(20px,2.4vw,32px)] max-w-none text-resolve-dim leading-relaxed [&>p+p]:mt-4">
          <p className="m-0">
      ...
      <CommercialClose
        ...
        heading={
          <>
            The method is the same whether or not{' '}
            <span style={{ color: 'var(--resolve-accent-deep)' }}>you hire us.</span>
          </>
        }
        body={
          <>
