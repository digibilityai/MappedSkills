  ...
  return (
    <>
      ...
      <CommercialHero
        ...
        <h1 className='m-0 mt-[clamp(14px,1.8vw,22px)] font-heading text-[clamp(2rem,4.6vw,3.9rem)] font-extrabold leading-[0.98] tracking-[-0.038em] max-w-none text-black'>Lead generation, where the unit is an enquiry <span style={{ color: 'var(--resolve-accent-deep)' }}> you can actually act on.</span></h1>
      ...
      <CommercialSection>
        <div className="max-w-[68%] max-[1024px]:max-w-none">
          ...
          <p className="mt-4 max-w-none text-resolve-dim leading-relaxed">
            <b className="font-bold text-resolve-ink">Not enough enquiries.</b> The demand exists somewhere and it is not arriving
            here.
          </p>
          <p className="mt-4 max-w-none text-resolve-dim leading-relaxed">
            <b className="font-bold text-resolve-ink">Or enough enquiries and the wrong ones</b> &mdash; job applications, course
      ...
      <CommercialSection tone="paper">
        <Display className="max-w-none">The questions this <span style={{ color: 'var(--resolve-accent-deep)' }}> page gets asked</span></Display>
      ...
      <CommercialClose
        ...
        heading={<>How many, and how many are <span style={{ color: 'var(--resolve-accent-deep)' }}>worth quoting for.</span></>}
        body={
          <>
