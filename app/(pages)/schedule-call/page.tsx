...
import { CommercialSection, ChapterLabel, Display } from '@/components/commercial/primitives';
...
const COVERS = [
  <><span className="text-resolve-dim">What you sell, and what one customer is worth.</span></>,
  <><span className="text-resolve-dim">What is happening now with enquiries.</span></>,
  <><span className="text-resolve-dim">What you can currently measure.</span></>,
  <><span className="text-resolve-dim">Where, on the evidence available in a conversation, the loss is most likely to be.</span></>,
];

const BRING = [
  <><span className="text-resolve-dim">How many enquiries you get in a typical month, roughly.</span></>,
  <><span className="text-resolve-dim">Roughly how many of those are worth quoting for.</span></>,
  <><span className="text-resolve-dim">Whether you can see where any of them came from.</span></>,
];
...
export default function ScheduleCallPage() {
  return (
    <>
      <RouteHero
        eyebrow="Booking"
        title={<>Book a time <span style={{ color: 'var(--resolve-accent-deep)' }}> to talk.</span></>}
        lede={
          <><p className='text-[clamp(1.06rem,1.35vw,1.28rem)]'>
            ...
            what would have to be true for that to change.</p>
          </>
        }
        size="quiet"
        mode="editorial"
      ...
      */}
      <CommercialSection>
        ...
        <Display>Four things, and none of them is a <span style={{ color: 'var(--resolve-accent-deep)' }}> pitch.</span></Display>
        <StatedList items={COVERS} />
      </CommercialSection>

      {/* ------------------------------------------------------------- §2 */}
      <CommercialSection tone="paper">
        <div className="max-w-[68%] max-[1024px]:max-w-none">
          <ChapterLabel>What you get from it either way</ChapterLabel>
          <Display>A view on which of four things is most likely <span style={{ color: 'var(--resolve-accent-deep)' }}> losing you enquiries.</span></Display>
          <p className="mt-4 max-w-none text-resolve-dim leading-relaxed">
      ...
      <CommercialSection>
        <div className="max-w-[68%] max-[1024px]:max-w-none">
          ...
          <Display>Three things <span style={{ color: 'var(--resolve-accent-deep)' }}> it will not be.</span></Display>
          <p className="mt-4 max-w-none text-resolve-dim leading-relaxed">
      ...
      <CommercialSection tone="paper">
        ...
        <Display>Rough numbers are <span style={{ color: 'var(--resolve-accent-deep)' }}> enough.</span></Display>
      ...
      */}
      <CommercialSection>
        ...
        <Display>The form reaches <span style={{ color: 'var(--resolve-accent-deep)' }}> the same place.</span></Display>
        <p className="mt-4 max-w-none text-resolve-dim leading-relaxed">
