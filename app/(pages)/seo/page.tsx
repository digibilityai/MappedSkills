...
import { Breadcrumb, CommercialSection, ChapterLabel, Display, Note, ProofLink } from '@/components/commercial/primitives';
  ...
  return (
    <>
      ...
      <CommercialHero
        ...
        <h1 className='m-0 mt-[clamp(14px,1.8vw,22px)] font-heading text-[clamp(2rem,4.6vw,3.9rem)] font-extrabold leading-[0.98] tracking-[-0.038em] max-w-none text-black'>SEO that is judged on the <span style={{ color: 'var(--resolve-accent-deep)' }}> enquiries it produces.</span></h1>
        <p className='text-[clamp(1.06rem,1.35vw,1.28rem)]'>
          We do the organic search work: technical foundations, site structure, indexation, internal linking, and content built for the searches that actually indicate someone wants to buy.
        </p>
        <p className='text-[clamp(1.06rem,1.35vw,1.28rem)]'>
      ...
      <CommercialSection tone="paper">
        <Display className="max-w-none">What the work involves, <span style={{ color: 'var(--resolve-accent-deep)' }}> month to month</span></Display>
      ...
      <CommercialSection tone="paper">
        <div className="max-w-[68%] max-[1024px]:max-w-none">
          <Display className="max-w-none">How you will know whether <span style={{ color: 'var(--resolve-accent-deep)' }}> it worked</span></Display>
      ...
      <CommercialSection>
        <Display className="max-w-none">The three questions <span style={{ color: 'var(--resolve-accent-deep)' }}> we get asked here</span></Display>
      ...
      <CommercialClose
        ...
        heading={
          <>
            ...
            <span style={{ color: 'var(--resolve-accent-deep)' }}>today.</span>
          </>
        }
        body={
          <>
