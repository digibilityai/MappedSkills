...
export default async function WorkPage() {
  ...
  return (
    <>
      <RouteHero
        eyebrow="Work"
        title={<>What we can show you, and <span style={{ color: 'var(--resolve-accent-deep)' }}> what we cannot.</span></>}
        lede={
      ...
      {caseStudies.length > 0 ? (
        ...
        <CommercialSection tone="paper">
          <div className="max-w-[95%] max-[1024px]:max-w-none">
            ...
            <Display>Permission, not results, <span style={{ color: 'var(--resolve-accent-deep)' }}> what is missing. </span></Display>
            <p className="mt-4 text-resolve-dim leading-relaxed">
      ...
      <CommercialSection>
        ...
        <Display>Three things, and one of them found <span style={{ color: 'var(--resolve-accent-deep)' }}> our own failures. </span></Display>
        <div className="mt-[clamp(24px,3vw,40px)] border-t-2 border-resolve-ink">
          <div className="border-b border-resolve-line py-[clamp(18px,2.2vw,28px)]">
            ...
            <p className="mt-3 max-w-none leading-relaxed text-resolve-dim">
