...
export default function RootLayout({
  ...
  /*
    suppressHydrationWarning is required on <html> because the homepage
    pre-paint script in HomepageHero writes `data-rsv-hero="traffic"` on
    documentElement before React hydrates (dark-first hero, no light→dark
    flash). That attribute is not in this Server Component's props, which
    is an intentional mismatch. The flag applies only to this element's
    attributes, not to descendants.
  */
  return (
    <html
      lang="en"
