  ...
  return (
    <figure className="m-0 mt-[clamp(30px,3.6vw,52px)]">
      ...
      >
        ...
        <p className="mt-2 max-w-none text-[.96rem] leading-relaxed text-resolve-dim">
      ...
      <p className="mt-[clamp(16px,2vw,24px)] max-w-none text-[.9rem] leading-[1.55] text-resolve-dim">
