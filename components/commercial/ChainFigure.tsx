...
const FULL_TITLE =
  'The journey from a buyer finding you to a recorded qualified enquiry, with the four joins between its parts marked';
const FULL_DESC =
  'One continuous chain with five points in order: buyer finds you, lands on your website, engages, enquires, ' +
  'and qualified enquiry. Buyer demand before discovery is dashed because it is not measured. Four joins are ' +
  'marked in tangerine and numbered 01 to 04: between the search work and the page it feeds, between the page ' +
  'and the form, between the form and where the enquiry lands, and between all of that and the measurement. ' +
  'Capture covers the discovery point; convert covers landing through the enquiry; measure covers the qualified ' +
  'enquiry and the boundary. One enquiry arrives from an open, dashed mark with no upstream segment: it is ' +
  'unattributed and it still counts. A rule crosses the chain after the qualified enquiry, marking where our ' +
  'marketing responsibility ends. The segment beyond it is a double line because it is your own opportunity ' +
  'and revenue data, from your own system.';
...
export function ChainFull() {
  const vertical = (
    <svg viewBox="0 0 330 636" role="img" aria-labelledby="f-full-v-t f-full-v-d" className="block h-auto w-full">
      ...
      <text x="78" y="60" {...nodeText}>Buyer finds you</text>
      <rect x="41" y="135" width="14" height="14" fill={INK} />
      <text x="78" y="148" {...nodeText}>Lands on your website</text>
      <rect x="41" y="223" width="14" height="14" fill={INK} />
      <text x="78" y="236" {...nodeText}>Engages</text>
      <rect x="41" y="311" width="14" height="14" fill={INK} />
      <text x="78" y="324" {...nodeText}>Enquires</text>
      ...
      <text x="78" y="396" {...smallText}>one arrived with no usable trail</text>

      <rect x="41" y="435" width="14" height="14" fill={INK} />
      <text x="78" y="448" {...nodeText}>Qualified enquiry</text>

      {/* the accountability boundary */}
      <line x1="6" y1="500" x2="324" y2="500" stroke={INK} strokeWidth={2} />
      <text x="6" y="490" {...bdText}>OUR MARKETING RESPONSIBILITY</text>
      ...
      <text x="78" y="542" {...nodeText}>Opportunity / Revenue</text>
      <text x="78" y="562" {...smallText}>your numbers, from your system</text>
  ...
  const horizontal = (
    <svg viewBox="0 0 1000 268" role="img" aria-labelledby="f-full-h-t f-full-h-d" className="block h-auto w-full">
      ...
      <text x="616" y="48" {...smallText}>it still counts</text>

      <text x="63" y="186" {...nodeText}>Buyer finds</text>
      <text x="63" y="204" {...nodeText}>you</text>
      <text x="246" y="186" textAnchor="middle" {...nodeText}>Lands on</text>
      <text x="246" y="204" textAnchor="middle" {...nodeText}>your website</text>
      <text x="422" y="186" textAnchor="middle" {...nodeText}>Engages</text>
      <text x="598" y="186" textAnchor="middle" {...nodeText}>Enquires</text>
      <text x="774" y="186" textAnchor="middle" {...nodeText}>Qualified</text>
      <text x="774" y="204" textAnchor="middle" {...nodeText}>enquiry</text>

      {/* the accountability boundary */}
      <line x1="862" y1="88" x2="862" y2="170" stroke={INK} strokeWidth={2} />
      <text x="862" y="78" textAnchor="middle" {...bdText}>OUR MARKETING RESPONSIBILITY</text>
      ...
      <text x="1000" y="186" textAnchor="end" {...nodeText}>Opportunity / Revenue</text>
      <text x="1000" y="222" textAnchor="end" {...smallText}>your numbers, from your system</text>
  ...
  return (
    <Figure
      ...
      caption={
        <>
          Illustrative journey only. Spacing does not represent volume, rate, duration or performance. The four
          numbered joins are ours to own, in order: search work to the page, page to form, form to the enquiry,
          and all of that to the measurement.
        </>
      }
    />
  );
