...
export function CommercialClose({
  ...
  return (
    <section className="border-t-2 border-resolve-ink bg-resolve-ground py-[var(--resolve-section-md)] text-resolve-ink">
      <Container>
        <div className={cn(OPENER_GRID[mode], mode === 'centred' && 'text-center')}>
          ...
          <div className={OPENER_MAIN[mode]}>
            {mode !== 'split' && (
              <p
                className={cn(
                  'm-0 mt-[18px] max-w-[32ch] font-heading text-[clamp(1.8rem,3.8vw,3rem)] font-extrabold leading-[0.99] tracking-[-0.038em]',
                  mode === 'centred' && 'mx-auto',
            ...
            <p
              className={cn(
                'mt-[20px] max-w-[64ch] leading-relaxed text-resolve-dim',
                mode === 'centred' && 'mx-auto',
            ...
            <div className={cn(mode === 'centred' && '[&>div]:justify-center')}>
