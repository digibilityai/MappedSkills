...
/* `lead0` / `step` / `stopAt` are the approved prototype's own per-mark
   ...
   quantity. */
const ROUTES = [
  { lead: 'Buyers are searching, but', clause: 'finding somebody else.', marks: 4, lead0: 0, step: 60, stopAt: 200 },
  { lead: 'People visit your website, but', clause: 'too few enquire.', marks: 7, lead0: 120, step: 60, stopAt: 500 },
  { lead: 'Enquiries arrive, but', clause: 'you cannot see what created them.', marks: 10, lead0: 240, step: 50, stopAt: 720 },
];
  ...
  return (
    <section className="border-t border-resolve-line bg-resolve-ground py-[var(--resolve-section-lg)] text-resolve-ink">
      <Container>
        ...
        <h2 className="rsv-rv mt-[18px] max-w-[16ch] font-heading text-[clamp(2rem,5vw,4.3rem)] font-extrabold leading-[0.95] tracking-[-0.035em]">
          Three marketing problems.{' '}
          <span style={{ color: 'var(--resolve-accent-deep)' }}>One broken path.</span>
        </h2>
        ...
        <p className="rsv-rv mt-5 text-resolve-dim">
          Without proper measurement, all three can look like the same problem:{' '}
          <b className="font-bold text-resolve-ink">marketing isn&rsquo;t working.</b>
        </p>
        <Link
