...
const STAGES: Stage[] = [
  {
    n: '01',
    title: 'Capture',
    body: 'Get found by buyers already looking. Some demand never reaches you at all.',
    links: [
      { href: '/seo', label: 'SEO' },
  ...
  },
  {
    n: '02',
    title: 'Convert',
    body: 'Turn more relevant visits into real enquiries.',
    links: [
  ...
  },
  {
    n: '03',
    title: 'Measure',
    body: 'See what created the enquiry and where opportunities are being lost.',
...
export function HomepageIntervention() {
  return (
    <section className="border-t border-resolve-line bg-resolve-ground py-[var(--resolve-section-lg)] text-resolve-ink">
      <Container>
        ...
        <h2 className="rsv-rv mt-[18px] max-w-[18ch] font-heading text-[clamp(2rem,5vw,4.3rem)] font-extrabold leading-[0.95] tracking-[-0.035em]">
          One system from buyer demand{' '}
          <span style={{ color: 'var(--resolve-accent-deep)' }}>to qualified enquiry.</span>
        </h2>
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <text className="rsv-fade" style={d(1560)} x="6" y="370" {...bdText}>OUR MEASUREMENT ENDS HERE</text>
      ...
      >
        ...
        <text className="rsv-fade" style={d(1560)} x="624" y="350" textAnchor="end" {...bdText}>OUR MEASUREMENT ENDS HERE</text>
      ...
      >
        ...
        <text className="rsv-fade" style={d(1020)} x="580" y="61" textAnchor="end" {...nodeText}>arrived with no usable trail</text>
        ...
        <text className="rsv-fade" style={d(1560)} x="862" y="58" textAnchor="middle" {...bdText}>OUR MEASUREMENT ENDS HERE</text>
