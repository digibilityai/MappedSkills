...
Write-Host "Upload this zip to the app root, extract, then:"
Write-Host "  npm install"
Write-Host "  # DO NOT run npm run build on the server"
Write-Host "  # Restart Node app with startup file: server.cjs"
Write-Host ""
Write-Host ".htaccess: MERGE the repo file into ~/public_html/.htaccess."
Write-Host "  Keep existing PassengerAppRoot / PassengerStartupFile / SetEnv lines."
Write-Host "  Do not restore WordPress rewrite/proxy rules."
Write-Host ""
